	...
	constantBufferColor(new ConstantBuffer<ConstantBufferDataColor>)
{
	...
	CD3DX12_RESOURCE_DESC texturenResourceDesc =
		CD3DX12_RESOURCE_DESC::Tex2D(
			...
			1, 1, 0, 1, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET);
	...
	RenderBase::GetInstance()->CreateSRV(texture, texturenResourceDesc);
}
...
{
	return nullptr;//componentManager->GetComponent<Texture>();
}